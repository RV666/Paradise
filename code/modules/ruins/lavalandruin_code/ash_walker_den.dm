...
/obj/effect/mob_spawn/human/ash_walker
	...
	Вдалеке виден свет... он предвещает приход чужаков, которые стремятся разорвать на части Некрополь и его владения. Они - наши будущие жертвы. \
	<br><i>Вы можете свободно атаковать шахтеров и других сущностей.<font size=4>НО</font> не покидайте Лаваленд без разрешения Администрации. <font size=4>А ТАКЖЕ НЕ СОВЕТУЕТСЯ</font> провоцировать шахтёров разрушая их базу.</b></i>"
