/mob/living/carbon/human/emote(act, m_type = 1, message = null, force)
	...
	switch(act)
		...
		if("howl", "howls")
			...
			if(miming)
				...
				if(!muzzled)
					...
					playsound(loc, 'sound/goonstation/voice/howl.ogg', 100, 1, 10, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
					message = "<B>[src]</B> издает очень громкий шум[M ? " на [M]" : ""]."
					playsound(loc, 'sound/goonstation/voice/howl.ogg', 25, 1, 10, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2

		if("growl", "growls")
			var/M = handle_emote_param(param)
			message = "<B>[src]</B> рычит[M ? " на [M]" : ""]."
			playsound(loc, "growls", !muzzled ? 80:25, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2

		if("purr", "purrs")
			message = "<B>[src]</B> мурчит."
			playsound(src, 'sound/voice/cat_purr.ogg', 80, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2

		if("purrl")
			message = "<B>[src]</B> мурчит."
			playsound(src, 'sound/voice/cat_purr_long.ogg', 80, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("ping", "pings")
			...
			playsound(loc, 'sound/machines/ping.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("buzz2")
			...
			playsound(loc, 'sound/machines/buzz-two.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("buzz", "buzzes")
			...
			playsound(loc, 'sound/machines/buzz-sigh.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("beep", "beeps")
			...
			playsound(loc, 'sound/machines/twobeep.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("drone", "drones", "hum", "hums", "rumble", "rumbles")
			...
			playsound(loc, 'sound/voice/drasktalk.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("squish", "squishes")
			...
			playsound(loc, 'sound/effects/slime_squish.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit to DrMinky (freesound.org) for the sound.
			m_type = 2
		...
		if("clack", "clacks")
			...
			playsound(loc, 'sound/effects/Kidanclack.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit to DrMinky (freesound.org) for the sound.
			m_type = 2
		...
		if("click", "clicks")
			...
			playsound(loc, 'sound/effects/Kidanclack2.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit to DrMinky (freesound.org) for the sound.
			m_type = 2
		...
		if("creaks", "creak")
			...
			playsound(loc, 'sound/voice/dionatalk1.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit https://www.youtube.com/watch?v=ufnvlRjsOTI [0:13 - 0:16]
			m_type = 2
		...
		if("hiss", "hisses")
			...
			if(!muzzled)
				...
				playsound(loc, 'sound/effects/unathihiss.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit to Jamius (freesound.org) for the sound.
				m_type = 2
			else
		...
		if("quill", "quills")
			...
			playsound(loc, 'sound/effects/voxrustle.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //Credit to sound-ideas (freesfx.co.uk) for the sound.
			m_type = 2
		...
		if("warble", "warbles")
			...
			playsound(loc, 'sound/effects/warble.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) // Copyright CC BY 3.0 alienistcog (freesound.org) for the sound.
			m_type = 2
		...
		if("yes")
			...
			playsound(loc, 'sound/machines/synth_yes.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("no")
			...
			playsound(loc, 'sound/machines/synth_no.ogg', 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 2
		...
		if("choke", "chokes")
			if(miming)
				...
				if(!muzzled)
					...
					if(gender == FEMALE)
						playsound(src, pick('sound/voice/gasp_female1.ogg','sound/voice/gasp_female2.ogg','sound/voice/gasp_female3.ogg','sound/voice/gasp_female4.ogg','sound/voice/gasp_female5.ogg','sound/voice/gasp_female6.ogg','sound/voice/gasp_female7.ogg'), 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, pick('sound/voice/gasp_male1.ogg','sound/voice/gasp_male2.ogg','sound/voice/gasp_male3.ogg','sound/voice/gasp_male4.ogg','sound/voice/gasp_male5.ogg','sound/voice/gasp_male6.ogg','sound/voice/gasp_male7.ogg'), 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
				...
				if(!muzzled)
					...
					if(gender == FEMALE)
						if(dna.species.female_cough_sounds)
							playsound(src, pick(dna.species.female_cough_sounds), 120, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						if(dna.species.male_cough_sounds)
							playsound(src, pick(dna.species.male_cough_sounds), 120, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
				else
					message = "<B>[src]</B> издает сильный шум."
					m_type = 2
		...
		if("gasp", "gasps")
			if(miming)
				...
				if(!muzzled)
					...
					if(health <= 0)
						if(gender == FEMALE)
							playsound(loc, pick(dna.species.female_dying_gasp_sounds), 100, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
						else
							playsound(loc, pick(dna.species.male_dying_gasp_sounds), 100, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))

					else
						playsound(loc, dna.species.gasp_sound, 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
		...
		if("deathgasp", "deathgasps")
			...
			playsound(loc, pick(dna.species.death_sounds), 50, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
			m_type = 1
		...
		if("giggle", "giggles")
			if(miming)
				...
				if(!muzzled)
					...
					if(gender == FEMALE)
						playsound(src, pick('sound/voice/giggle_female_1.ogg','sound/voice/giggle_female_2.ogg','sound/voice/giggle_female_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, pick('sound/voice/giggle_male_1.ogg','sound/voice/giggle_male_2.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
					message = "<B>[src]</B> издает шум."
					m_type = 2
		...
		if("cry", "cries")
			if(miming)
				...
				if(!muzzled)
					message = "<B>[src]</B> плачет."
					if(gender == FEMALE)
						playsound(src, pick('sound/voice/cry_female_1.ogg','sound/voice/cry_female_2.ogg','sound/voice/cry_female_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, pick('sound/voice/cry_male_1.ogg','sound/voice/cry_male_2.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
		...
		if("sigh", "sighs")
			if(miming)
				...
				if(!muzzled)
					message = "<B>[src]</B> вздыхает."
					if(gender == FEMALE)
						playsound(src, 'sound/voice/sigh_female.ogg', 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, 'sound/voice/sigh_male.ogg', 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
					message = "<B>[src]</B> издает слабый шум."
					m_type = 2
		...
		if("laugh", "laughs")
			...
			if(miming)
				...
				if(!muzzled)
					...
					if(gender == FEMALE)
						playsound(src, pick('sound/voice/laugh_female_1.ogg','sound/voice/laugh_female_2.ogg','sound/voice/laugh_female_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, pick('sound/voice/laugh_male_1.ogg','sound/voice/laugh_male_2.ogg','sound/voice/laugh_male_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
					message = "<B>[src]</B> издает шум."
					m_type = 2
		...
		if("moan", "moans")
			if(miming)
				...
				if(gender == FEMALE)
					playsound(src, pick('sound/voice/moan_female_1.ogg','sound/voice/moan_female_2.ogg','sound/voice/moan_female_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
				else
					playsound(src, pick('sound/voice/moan_male_1.ogg','sound/voice/moan_male_2.ogg','sound/voice/moan_male_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
				m_type = 1
			else
		...
		if("sneeze", "sneezes")
			if(miming)
				...
				if(!muzzled)
					message = "<B>[src]</B> чихает."
					if(gender == FEMALE)
						playsound(src, dna.species.female_sneeze_sound, 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(src, dna.species.male_sneeze_sound, 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
		...
		if("snore", "snores")
			if(miming)
				...
				if(!muzzled)
					...
					playsound(src, pick('sound/voice/snore_1.ogg', 'sound/voice/snore_2.ogg','sound/voice/snore_3.ogg', 'sound/voice/snore_4.ogg','sound/voice/snore_5.ogg', 'sound/voice/snore_6.ogg','sound/voice/snore_7.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					m_type = 2
				else
					message = "<B>[src]</B> издает шум."
					m_type = 2
		...
		if("yawn", "yawns")
			if(!muzzled)
				...
				if(gender == FEMALE)
					playsound(src, pick('sound/voice/yawn_female_1.ogg', 'sound/voice/yawn_female_2.ogg','sound/voice/yawn_female_3.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
				else
					playsound(src, pick('sound/voice/yawn_male_1.ogg', 'sound/voice/yawn_male_2.ogg'), 70, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
				m_type = 2
				if(miming)
					m_type = 1
		...
		if("scream", "screams")
			...
			if(miming)
				...
				if(!muzzled)
					...
					m_type = 2
					if(gender == FEMALE)
						playsound(loc, dna.species.female_scream_sound, 80, 1, frequency = get_age_pitch() + (0.01*rand(-5,5)))
					else
						playsound(loc, dna.species.male_scream_sound, 80, 1, frequency = get_age_pitch() + (0.01*rand(-5,5))) //default to male screams if no gender is present.
