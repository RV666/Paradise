...
/datum/event/prison_break/announce()
	if(areas && areas.len > 0)
		GLOB.event_announcement.Announce("[pick("Gr3y.T1d3 вирус","Злостный троян")] обнаружен в [station_name()] [(eventDept == "Security")? "imprisonment":"containment"] подпрограммах. Защитите любые скомпрометированные области немедленно. Участие станционного ИИ рекомендуется.", "[eventDept] Alert")
