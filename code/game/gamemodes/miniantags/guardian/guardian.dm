/mob/living/simple_animal/hostile/guardian
	...
	var/magic_fluff_string = " Кодер символизирующий ошибки и ошибки, должен был исправить это но вместо этого появился тут. Отправьте отчет об ошибке!"
	var/tech_fluff_string = "ПОСЛЕДОВАТЕЛЬНОСТЬ ЗАГРУЗКИ ЗАВЕРШЕНА. МОДУЛЬ ОШИБОК ЗАГРУЖЕН. ЭТОГО НЕ ДОЛЖНО БЫЛО СЛУЧИТЬСЯ. Отправьте отчет об ошибке!"
	var/bio_fluff_string = "Ваши скрабы не мутируют. Этого не должно было случиться! Отправьте отчет об ошибке!"
